...
import '../../assets/styles/AddWorker.css'; // Importa los estilos CSS
      ...
      <form>
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            ...
            <input type="number" id="cantGrupoConferencia" name="cantGrupoConferencia" defaultValue={0} />
          </div>
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input type="number" id="cantGrupoClasePractica" name="cantGrupoClasePractica" defaultValue={0} />
          </div>
          <div className="form-group">
            <label htmlFor="anioGraduado">Año Graduado</label>
            <select id="anioGraduado" name="anioGraduado">
          ...
          <div className="form-group">
            ...
            <input type="text" id="aniosExperiencia" name="aniosExperiencia" placeholder="Vacío" />
          </div>
          <div className="form-group">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <select id="cursoImparte" name="cursoImparte">
          ...
          <div className="form-group">
            ...
            <select id="categoriaDocente" name="categoriaDocente">
              <option value="Seleccionar">Seleccionar</option>
          ...
          <div className="form-group">
            ...
            <select id="anioAcademico" name="anioAcademico">
              <option value="Seleccionar">Seleccionar</option>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <select id="responsabilidad" name="responsabilidad">
              <option value="Seleccionar">Seleccionar</option>
          ...
          <div className="form-group">
            ...
            <select id="categoriaCientifica" name="categoriaCientifica">
              <option value="Seleccionar">Seleccionar</option>
