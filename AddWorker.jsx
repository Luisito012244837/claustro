...
const AddWorker = () => {
  ...
  const handleCancel = () => {
    MySwal.fire({
      ...
      confirmButtonColor: darkMode ? '#007a5a' : '#00b87a', // Verde oscuro para tema oscuro, verde claro para tema claro
      cancelButtonColor: darkMode ? '#444444' : '#cccccc', // Gris oscuro para tema oscuro, gris claro para tema claro
      background: darkMode ? '#1a1a2e' : '#ffffff', // Fondo negro para tema oscuro, blanco para tema claro
      color: darkMode ? '#e6e6e6' : '#333333', // Texto blanco para tema oscuro, negro para tema claro
    }).then((result) => {
