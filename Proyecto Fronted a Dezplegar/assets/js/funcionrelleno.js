...
async function populateCourseSelect() {
    try {
        ...
        const data = await fetchData('http://192.168.138.176:8000/apiv2/tipo-curso/');
...
async function populateCategoriaDocenteSelect() {
    try {
        ...
        select.innerHTML = '';
        // Obtener datos de la API
        const data = await fetchData('http://192.168.138.176:8000/apiv2/categoria-docente/');
...
async function populateAnnoAcademicoSelect() {
    try {
        ...
        select.innerHTML = '';
        // Obtener datos de la API
        const data = await fetchData('http://192.168.138.176:8000/apiv2/anno-academico/');
...
async function populateCareerSelect() {
    try {
        ...
        select.innerHTML = '';
        // Obtener datos de la API
        const data = await fetchData('http://192.168.138.176:8000/apiv2/carrera/');
...
async function populateResponsabilidadSelect() {
    try {
        ...
        select.innerHTML = '';
        // Obtener datos de la API
        const data = await fetchData('http://192.168.138.176:8000/apiv2/responsabilidad/');
...
async function populateCargoSelect() {
    try {
        ...
        select.innerHTML = '';
        // Obtener datos de la API
        const data = await fetchData('http://192.168.138.176:8000/apiv2/cargo/');
...
async function populateCategoriaCientificaSelect() {
    try {
        ...
        select.innerHTML = '';
        // Obtener datos de la API
        const data = await fetchData('http://192.168.138.176:8000/apiv2/categoria-cientifica/');
...
async function populateAsignaturaSelect() {
    try {
        ...
        select.innerHTML = '';
        // Obtener datos de la API
        const data = await fetchData('http://192.168.138.176:8000/apiv2/asignatura/');
...
async function populateAreaSelect() {
    try {
        ...
        select.innerHTML = '';
        // Obtener datos de la API
        const data = await fetchData('http://192.168.138.176:8000/apiv2/area/');
